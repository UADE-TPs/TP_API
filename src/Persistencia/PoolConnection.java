...
public class PoolConnection
{
	...
	private Connection connect()
	{
		...
		{
			System.out.println("Mensaje1 Error: " + e.getMessage());
			System.out.println("Stack1 Trace: " + e.getStackTrace());
			return null;
		}
		catch (Exception ex)
		{
			System.out.println("Mensaje2 Error: " + ex.getMessage());
			System.out.println("Stack2 Trace: " + ex.getStackTrace());
			return null;
		}
	}
